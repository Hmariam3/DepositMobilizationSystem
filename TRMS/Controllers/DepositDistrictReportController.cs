...
namespace TRMS.Controllers
{
    public class DepositDistrictReportController : Controller
    {
        ...
        public ActionResult DistrictPlanReport(DateTime? startDate, DateTime? endDate)
        {
            ...
            if ((userPosition == "Director" || userPosition == "SeniorDirector") && !string.IsNullOrEmpty(districtUser))
            {
        ...
        public ActionResult ExportDepositPlan(DateTime? startDate, DateTime? endDate)
        {
            ...
            {
                var ws = wb.Worksheets.Add("District_SP Deposit Report"); // Add worksheet
                ...
                return File(stream,
                    ...
                    "District_Subprocess Deposit Report.xlsx");
            }
        ...
        public ActionResult ExportDepositAgent(DateTime? startDate, DateTime? endDate)
        {
            ...
            using (var wb = new XLWorkbook()) // Create workbook
            {
                var ws = wb.Worksheets.Add("District_SP Merchant Report"); // Add worksheet
                ...
                return File(stream,
                    "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
                    "District_Subprocess Merchant Report.xlsx");
            }
        ...
        public ActionResult ExportDepositFcy(DateTime? startDate, DateTime? endDate)
        {
            ...
            using (var wb = new XLWorkbook()) // Create workbook
            {
                var ws = wb.Worksheets.Add("District_SP FCY Report"); // Add worksheet
                ...
                return File(stream,
                    "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
                    "District_Subprocess FCY Report.xlsx");
            }
