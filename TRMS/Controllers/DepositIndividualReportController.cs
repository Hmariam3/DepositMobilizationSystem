...
namespace TRMS.Controllers
{
    public class DepositIndividualReportController : Controller
    {
        ...
        public ActionResult ExportToExcel(DateTime? startDate, DateTime? endDate)
        {
            ...
            {
                var ws = wb.Worksheets.Add("Individual Deposit Report"); // Add sheet
        ...
        public ActionResult ExportDepositAgent(DateTime? startDate, DateTime? endDate)
        {
            ...
            using (var wb = new XLWorkbook()) // Create workbook
            {
                var ws = wb.Worksheets.Add("Individual Merchant Report"); // Add sheet
                ...
                return File(stream, "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "Individual Merchant Report.xlsx");
            }
        ...
        public ActionResult ExportDepositFcy(DateTime? startDate, DateTime? endDate)
        {
            ...
            using (var wb = new XLWorkbook()) // Create workbook
            {
                var ws = wb.Worksheets.Add("Individual  Fcy Report"); // Add sheet
                ...
                return File(stream, "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "Individual Fcy Report.xlsx");
            }
